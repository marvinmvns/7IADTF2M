...
def run_batch():
    ...
    # Using lowercase values as required by Enums
    num_runs = 5
    base_config = {
        "scenario": "medium",
        "population_size": 100,
        ...
        "stagnation_limit": 1000, # Increased stagnation limit to allow finding deeper optima
        "elite_size": 2,
        "tournament_size": 3
    }
    ...
    if results:
        ...
        if fitnesses:
            ...
            # Check if we beat the invalid/previous record (~1061)
            if best_of_batch < 1061.21:
                print("SUCCESS: Beat the specific 1061.21 barrier!")
            else:
                print("Result: Did not beat the 1061.21 barrier.")
